...
public class InterfazPorComision extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        tarifa = 0.5;
        EmpleadoPorComision EPC = new EmpleadoPorComision(Nombre,Apellido,NSS,Ventas,tarifa);
        EPC.setNombre(Nombre);
        EPC.setApellido(Apellido);
        EPC.setNumeroSeguroSocial(NSS);
        EPC.setTarifaComision(tarifa);
        EPC.setVentasBrutas(Ventas);
