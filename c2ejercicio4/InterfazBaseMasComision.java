...
public class InterfazBaseMasComision extends javax.swing.JFrame {

    String Nombre,Apellido,NSS;
    double Ventas, tarifa,Sueldo;
    
    public InterfazBaseMasComision() {
        initComponents();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(txtSueldoBase, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(txtApellido, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        //Pase de parametros a un objeto
        EmpleadoBaseMasComision EBMC = new EmpleadoBaseMasComision();
        EBMC.setNombre(Nombre);
        EBMC.setApellido(Apellido);
        EBMC.setNumeroSeguroSocial(NSS);
        EBMC.setVentasBrutas(Ventas);
        EBMC.setTarifaComision(tarifa);
        EBMC.setSalarioBase(Sueldo);
    ...
    private void btnVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisualizarActionPerformed
       ...
       EmpleadoBaseMasComision EBMC = new EmpleadoBaseMasComision(Nombre,Apellido,NSS,Ventas,tarifa,Sueldo);
       String Salida = EBMC.toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazBaseMasComision.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazBaseMasComision().setVisible(true);
            }
        });
    }
